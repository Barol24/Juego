...
Player::Player(char _name[40], int health, int attack, int defense, int speed, int _poderMagico, string nacio) : Character(_name, health, attack, defense,
                                                                                        speed, true) {
